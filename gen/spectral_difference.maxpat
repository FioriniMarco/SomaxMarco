...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 293.0, 37.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 371.0, 371.0, 246.0, 119.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 45.0, 371.0, 313.0, 119.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 293.0, 107.0, 324.0, 78.0 ],
					"ruler" : 0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 101.5, 203.0, 56.0, 22.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 370.0, 71.0, 182.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 101.5, 163.0, 156.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 293.0, 71.0, 65.0, 22.0 ],
					"text" : "buftime 25"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 54.5, 363.0, 380.5, 363.0 ],
					"order" : 0,
					"source" : [ "obj-7", 0 ]
				}
...
, 			{
				...
				"bootpath" : "~/Documents/Max 8/Packages/genbook/2022",
				"patcherrelativepath" : ".",
				"type" : "gDSP",
				"implicit" : 1
			}
